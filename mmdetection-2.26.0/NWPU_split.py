...
class_names = ["airplane", "ship", "storage tank", "baseball diamond", "tennis court", "basketball court",
                "ground track field", "harbor", "bridge", " vehicle"]


def voc2coco(data_dir, train_file, val_file):
...
if __name__ == '__main__':
    data_dir = 'E://NWPU//NWPU VHR-10//nwpu_positive'
    train_file = 'E://NWPU//NWPU VHR-10//nwpu_positive//ImageSets//Main//train.txt'
    val_file = 'E://NWPU//NWPU VHR-10//nwpu_positive//ImageSets//Main//val.txt'
    # test_file = 'VOCdevkit/VOC2007/ImageSets/Main/test.txt'
    voc2coco(data_dir, train_file, val_file)