...
tif_file_path = r'E:\dataset1\AerialImageDataset\test\images'# 为tif图片的文件夹路径
tif_fileList = os.listdir(tif_file_path)
for tif_file in tif_fileList:
    file_path_name = tif_file_path + '/' + tif_file
    jpg_path = r'E:\dataset1\AerialImageDataset\test\tig2jpg' + '/' + tif_file.split('.')[0] + '.jpg' #.jpg图片的保存路径
