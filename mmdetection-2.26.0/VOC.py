...
def deal(path):
    ...
    outpath = "E:/NWPU/NWPU VHR-10/nwpu2coco/Annotations/"
    # 如果输出文件夹不存在，就创建它
    ...
    for file in files:
        ...
        if sufix == '.txt':  # 标注txt文件中每一行代表一个目标，(x1,y1)，(x2,y2)，class_number来表示
            ...
            imagepath = "E:/NWPU/NWPU VHR-10/nwpu2coco/JPEGImages/" + filename_fill + ".jpg"
    ...
    negative_path = "E:/NWPU/NWPU VHR-10/data/NWPU VHR-10 dataset/negative image set/"
...
if __name__ == "__main__":
    ...
    old_path = "E:/NWPU/NWPU VHR-10/data/NWPU VHR-10 dataset/positive image set/"
    new_path = "E:/NWPU/NWPU VHR-10/nwpu2coco/JPEGImages/"
    imag_rename(old_path, new_path)
    # 解决negative image set文件夹中的重命名问题，start_number = 650
    old_path = "E:/NWPU/NWPU VHR-10/data/NWPU VHR-10 dataset/negative image set/"
    new_path = "E:/NWPU/NWPU VHR-10/nwpu2coco/JPEGImages/"
    imag_rename(old_path, new_path, start_number=650)

    # path指定的是标注txt文件所在的路径
    path = "E:/NWPU/NWPU VHR-10/data/NWPU VHR-10 dataset/ground truth"
    deal(path)
