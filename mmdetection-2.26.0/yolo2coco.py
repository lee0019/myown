...
coco_format_save_path='E:\\RSOD\\RSOD-COCO-main\\coco'   #要生成的标准coco格式标签所在文件夹
yolo_format_classes_path='E:\\RSOD\\RSOD_Dataset\\names.txt'     #类别文件，一行一个类
yolo_format_annotation_path='E:\\RSOD\\RSOD-COCO-main\\RSOD-COCO-main\\labels\\val2017\\'  #yolo格式标签所在文件夹
img_pathDir='E:\\RSOD\\RSOD-COCO-main\\RSOD-COCO-main\\images\\val2017\\'    #图片所在文件夹
