...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='E://mmlab//mmdetection-2.26.0//tools//work_dirs//tridentnet_r50_caffe_1x_coco//tridentnet_r50_caffe_1x_coco_20201230_141838-2ec0b530.pth'),
...
work_dir = 'E://mmlab//mmdetection-2.26.0//tools//work_dirs//tridentnet_r50_caffe_1x_coco'
auto_resume = False
gpu_ids = [1]
