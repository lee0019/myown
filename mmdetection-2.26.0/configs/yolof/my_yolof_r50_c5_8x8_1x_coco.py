...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='E://mmlab//mmdetection-2.26.0//tools//work_dirs//yolof_r50_c5_8x8_1x_coco//resnet50_caffe-788b5fa3.pth')),
    neck=dict(
        type='DilatedEncoder',
        in_channels=2048,
        out_channels=512,
    ...
    test_cfg=dict(
        ...
        max_per_img=100))
work_dir = r'E:\mmlab\mmdetection-2.26.0\tools\work_dirs\yolof_1'
auto_resume = False
gpu_ids = [1]
