model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='E://mmlab//mmdetection-2.26.0//tools//work_dirs//contrast experiment//cascade_rcnn_r50_caffe_fpn_1x_coco//cascade_rcnn_r50_caffe_fpn_1x_coco_bbox_mAP-0.404_20200504_174853-b857be87.pth')),
    neck=dict(
        type='FPN',
...
work_dir = '/mmdetection-2.26.0/tools/work_dirs/contrast_experiment//cascade_rcnn_r50_caffe_fpn_1x_coco'
auto_resume = False
gpu_ids = [0]
