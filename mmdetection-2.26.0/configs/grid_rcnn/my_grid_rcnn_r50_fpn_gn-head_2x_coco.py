...
model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='E://mmlab//mmdetection-2.26.0//tools//work_dirs//grid_rcnn_r50_fpn_gn-head_2x_coco//grid_rcnn_r50_fpn_gn-head_2x_coco_20200130-6cca8223.pth')),
    neck=dict(
        type='FPN',
...
work_dir = 'E://mmlab//mmdetection-2.26.0//tools//work_dirs//grid_rcnn_r50_fpn_gn-head_2x_coco'
auto_resume = False
gpu_ids = [1]
