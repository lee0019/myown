model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='E://mmlab//mmdetection-2.26.0//tools//work_dirs//ga_rpn_r50_fpn_1x_coco//ga_rpn_r50_caffe_fpn_1x_coco_20200531-899008a6.pth')),
    neck=dict(
        type='FPN',
...
work_dir = 'E://mmlab//mmdetection-2.26.0//tools//work_dirs//ga_rpn_r50_fpn_1x_coco'
auto_resume = False
gpu_ids = [1]
